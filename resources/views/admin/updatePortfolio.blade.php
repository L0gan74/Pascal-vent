...
@section('title', 'Изменить портфолио')
...
@section('content')
    ...
    <form style="max-width: 300px;" method="post" action="{{ url('/admin/updatePortfolio') }}" enctype="multipart/form-data">
        @if ($errors->any())
        ...
        <input type="text" placeholder="текст" name="text" value="{{ $data->text }}" class="form-control m-2" />
